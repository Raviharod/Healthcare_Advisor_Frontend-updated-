function HealthHead(){
    return (
        ...
        <div className="w-full h-auto flex justify-between items-center gap-2">
            <div className="p-2">
                <h1 className="text-4xl font-bold">Extra Ordinary</h1>
                <h1 className="text-4xl font-bold text-[#2b7fff]">Health Solution</h1>
            </div>
            ...
            <div>
                <button className="p-2 rounded bg-[#2b7fff] text-white">Consult Doctor Now</button>
            </div>
        </div>
        </>
    )
